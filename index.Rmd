...
For introducing tools and packages we will be using swirl modules to teach about concrete tools or packages. Each swirl module is required and should be completed before class on the day that it is assigned. You get 100% if you complete the module before class and 0% if you have not completed the module. 
